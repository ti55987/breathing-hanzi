...
declare class RenderState {
    _mutationChains: MutationChain$0[];
    ...
    _run(mutationChain: MutationChain$0): void;
    _getActiveMutations(): GenericMutation<RenderState>[];
    pauseAll(): void;
    resumeAll(): void;
    cancelMutations(scopesToCancel: string[]): void;
    cancelAll(): void;
    _cancelMutationChain(mutationChain: MutationChain$0): void;
}
...
declare class Quiz {
    ...
    endUserStroke(): void;
    cancel(): void;
    _getStrokeData(isCorrect?: boolean): StrokeData;
    _handleSuccess(): void;
    _handleFailure(): void;
